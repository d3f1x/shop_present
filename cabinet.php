               ...
               <div id="catalog">
                  ...
                  <div id="admin_panel" style="background:none;">
                     <? 
                        ...
                        {
							echo '<button style="height: 75px; width: 300px; font-size: 22px; margin-top: 15px; background:#00adab; color:#fff;  cursor:pointer;"  class="spoiler-title">Добавить товар</button>
							...
							echo '<br><button style="height: 75px; width: 300px; font-size: 22px; margin-top: 15px; background:#00adab; color:#fff; cursor:pointer;"  class="spoiler-title2">Добавить новость дня</button> <div id="basket" class="spoiler-body2" style="font-size:24px;">
							...
							echo '<br><button style="height: 75px; width: 300px; font-size: 22px; margin-top: 15px; background:#00adab; color:#fff; cursor:pointer;"  class="spoiler-title3">Добавить рекламный баннер</button> <div id="basket" class="spoiler-body3" style="font-size:24px;">
